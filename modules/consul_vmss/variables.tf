...
variable "tier" {
  default     = "standard"
  type        = "string"
  description = "VM Tier to provision"
}
...
variable "spn_client_id" {
  description = "Service Principal Id used by the nodes to access auto-join and AKV."
}

variable "spn_client_secret" {
  description = "Service Principal Secret used by the nodes to access auto-join and AKV."
}

locals {
  module_name = "${var.name}"
  vmss_name   = "${local.module_name}vmss"
}
